            ...
            OkhttoUtils.get_getJson(GetURL.getSelectAlarm(param), new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    //rxjava会增加包大小,所以采用接口回调的方式
                        ...
                        mAlarmPop.transferAlarmValues(alarms);
                }
            });


        }
        private IAlarmPop mAlarmPop;
        public interface IAlarmPop{
            void transferAlarmValues(List list);
        }
        public void setIRTPop(IAlarmPop alarmPop){
            mAlarmPop= alarmPop;
        }
}
