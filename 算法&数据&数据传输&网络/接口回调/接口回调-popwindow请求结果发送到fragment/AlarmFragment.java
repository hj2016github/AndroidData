...
public class AlarmFragment extends Fragment implements View.OnClickListener,AlarmPopWindow.IAlarmPop {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ObtainAlarmValue();
        Singleton.getAlarmPopWindowInstance(getActivity()).setIRTPop(this);
    ...
    @Override
    public void transferAlarmValues(List list) {
        Message message = Message.obtain();
        message.obj  = list;
        message.what = 1;
        handler.sendMessage(message);
